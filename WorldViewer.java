    ...
    extends JFrame
{
  ...
  private BufferedImage background = new BufferedImage(
                                                       640,
                                                       480,
  ...
  {
    background = new BufferedImage(w.getWidth() * CELLSIZE, w.getHeight()
                                                            * CELLSIZE,
                                   BufferedImage.TYPE_INT_RGB);
    ...
    g.dispose();
    scroller.revalidate();
    generation.setText("Generation " + w.getGeneration() + " / Population "
                       + w.getPopulation());
    repaint();
  }
