    ...
    extends WorldImpl
{
  ...
  protected Color getCellAsColour(int col, int row)
  {
    ...
    final int[] colours = new int[] { 00000000, 16711680, 16717568, 16724224,
                                     16731136, 16738048, 16744960, 16751616,
                                     16758528, 16765440, 16772096, 16776982,
                                     16777062, 16777141 };
    if (age >= colours.length)
      {
        return Color.WHITE;
      }
    return new Color(colours[age]);
  }
}
